...
def main():
    ...
    parser.add_argument("--gamma", type=float, default=0.5,
                        help="Gamma value for reweighting (default: 0.5)")
    ...
    all_file = ["datasets/step2/processed_finetuning_data_all_lang.jsonl", "datasets/step2/sea_instruct_Burmese.jsonl", "datasets/step2/sea_instruct_Filipino.jsonl", "datasets/step2/sea_instruct_Indonesian.jsonl", "datasets/step2/sea_instruct_Malay.jsonl", "datasets/step2/sea_instruct_Tamil.jsonl", "datasets/step2/sea_instruct_Thai.jsonl", "datasets/step2/sea_instruct_Vietnamese.jsonl", "datasets/step2/seabed_training_data_without_negative.jsonl", "datasets/step2/seabed_training_data_with_negative.jsonl"]

    # Before the loop, to load if exists
    cache_file = os.path.join("datasets/step2/", f'concate_dataset_all_{args.dataset}.pkl')
    if os.path.exists(cache_file) and not args.force_reload:
        ...
        pickle.dump(concate_dataset, open(os.path.join("datasets/step2/", f'concate_dataset_all_{args.dataset}.pkl'), 'wb'))
    ...
    elif args.lr_type == "WarmupStableDecay":
